...
### Videos:
[LLM Security: The OWASP Top 10 Journey](https://youtu.be/kQUUWOZvSRY)

[SBOM, SBOM, you're an SBOM](https://youtu.be/6E3WSlYZmIk)

### Location:
[Celfocus, Av. Dom João II 34, 1998-031 Lisboa](https://maps.app.goo.gl/cy4D1sEuN1fNSdFB8)

This meetup was sponsored by [Celfocus](https://www.celfocus.com/) and [AP2SI](https://ap2si.org/).
...
![The entrance to the "Auditório" event space featuring a red vertical banner for the sponsor, Celfocus.](2024-03-05/000.jpg "OWASP Lisboa #6")
* * *
![The main stage screen displaying the title slide "OWASP Lisboa Meetups #06 The Eggs" with date and sponsor details, positioned above three red stools.](2024-03-05/001.jpg "OWASP Lisboa #6")
* * *
![A speaker presenting a slide titled "The Journey to OWASP Top 10 for LLM" next to a vertical OWASP banner.](2024-03-05/002.jpg "OWASP Lisboa #6")
* * *
![An audience member holding a microphone asks a question to the speaker, with a list of contributors displayed on the main screen.](2024-03-05/003.jpg "OWASP Lisboa #6")
* * *
![A speaker at the podium smiling in front of a humorous slide reading "SBOM, SBOM, You're an SBOM" with a cartoon illustration.](2024-03-05/004.jpg "OWASP Lisboa #6")
* * *
![A speaker explaining a "Bill of Materials" diagram on the screen, detailing SBOM, HBOM, and SaaSBOM concepts.](2024-03-05/005.jpg "OWASP Lisboa #6")